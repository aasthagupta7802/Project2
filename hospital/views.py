...
#for showing signup/login button for admin(by Aastha)
...
#for showing signup/login button for doctor(by Aastha)
...
#for showing signup/login button for patient(by Aastha)
